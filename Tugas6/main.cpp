...
int main(){
    ...
    do {
        ...
        cout << "Mau tiket VIP (tambah 10000) ? y/n:";
        cin >> jenisTiket;

        int tambahan = (jenisTiket=='y' || jenisTiket=='Y') ? 10000 : 0;
        harga = hargaPerTiket * jumlahTiket;
        pajak = 0.05 * harga;
        hargaTotal =  harga + pajak + tambahan;

        cout << endl;
        cout << "Anda membeli " << jumlahTiket << " tiket untuk menonton film " << filmPilihan;
        cout << "Berikut rincian harganya : \n";
        cout << "1. Harga tiket : " << jumlahTiket << " x " << hargaPerTiket << " = " << harga << endl;
        cout << "2. Pajak : 5% x " << harga << " = " << pajak << endl;
        cout << "3. Biaya tambahan : " << tambahan << endl;
        cout << "\nHarga yang harus anda bayar adalah Rp. " << hargaTotal << endl;
